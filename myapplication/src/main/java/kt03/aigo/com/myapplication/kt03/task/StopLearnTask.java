 ...
 */
public class StopLearnTask extends SafeAsyncTask<ResultObject> {

    private static final String TAG = StopLearnTask.class.getSimpleName();

    @Override
    public ResultObject call() throws Exception {

        try {
            StringBuffer url = new StringBuffer(Constant.URL_KT03 + "/send/stopLearn.json");
