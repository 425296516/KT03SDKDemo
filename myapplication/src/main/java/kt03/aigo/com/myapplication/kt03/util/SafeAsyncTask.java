package kt03.aigo.com.myapplication.kt03.util;

/**
 * Created by zhangcirui on 15/3/28.
 */

import android.os.Handler;

import com.goyourfly.base_task.AndroidCallable;
...
public abstract class SafeAsyncTask<ResultT>  implements Callable<ResultT> {
    ...
    public void execute() {
        final StackTraceElement[] launchLocation = Thread.currentThread().getStackTrace();
