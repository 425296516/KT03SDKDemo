...
import com.aigo.kt03airdemo.business.db.DbAirIndexInfoHelper;
...
public class DatabaseDump {
    ...
    public void exportData() {
        ...
        try {
            ...
            String sql = "SELECT * FROM TABLE_AIR_INDEX";

            Cursor cur = mSqLiteDatabase.rawQuery(sql, new String[0]);
            cur.moveToFirst();
    ...
    public List<DbAirIndexObject> queryAll() {
        ...
        String sql = "select * from " + mDbAirIndexInfoHelper.TABLE_AIR_INDEX + " order by _id asc";
